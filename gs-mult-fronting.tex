...
The exceptions to this are \citet{Grubacic65a}, \citet{Lee75a}, \citet{Loetscher85}, \citet[\page
...
\footnotetext{
Böll, Heinrich (1963): \emph{Ansichten eines Clowns}. Köln: Kiepenheuer \& Witsch. Quoted from
...
\z
% Freies Thema muss im Nominativ stehen. Altmann81: 50
%
...
\citet*{Loetscher85}\ia{Lötscher} has sketched the beginnings of a theory, which -- under certain conditions -- would allow
...
%% ``Nehmen wir an, dass die PP \emph{In Züpfners Box} ähnlich behandelt wird wie ein klassisches rahmenbildendes
