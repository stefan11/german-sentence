...
\z
%
In the analysis of (\mex{0}), the verbal argument of \emph{haben} is raised to the argument of the complex \emph{haben wird}.
The complex \emph{haben wird} is then combined with \emph{geholfen} via the Head"=Argument Schema. The analysis in (\mex{0})
